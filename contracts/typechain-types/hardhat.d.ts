...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "CreditCardFactory",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.CreditCardFactory__factory>;
    getContractFactory(
      name: "Dictator",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.Dictator__factory>;
    getContractFactory(
      name: "BaseAccount",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.CreditCardFactory>;
    getContractAt(
      name: "Dictator",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.Dictator>;
    getContractAt(
      name: "BaseAccount",
      address: string,
      signer?: ethers.Signer
