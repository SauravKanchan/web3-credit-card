...
export declare namespace TokenPaymaster {
  ...
  export type TokenPaymasterConfigStructOutput = [
    ...
    refundPostopCost: BigNumber;
    priceMaxAge: BigNumber;
  };
}
...
export interface TokenPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "setTokenPaymasterConfig((uint256,uint256,uint256,uint256))": FunctionFragment;
  ...
  events: {
    ...
    "PostOpReverted(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PostOpReverted"): EventFragment;
...
export interface PostOpRevertedEventObject {
  user: string;
  preCharge: BigNumber;
}
export type PostOpRevertedEvent = TypedEvent<
  [string, BigNumber],
  PostOpRevertedEventObject
>;

export type PostOpRevertedEventFilter = TypedEventFilter<PostOpRevertedEvent>;
...
export interface TokenPaymaster extends BaseContract {
  ...
  filters: {
    ...
    "PostOpReverted(address,uint256)"(
      user?: PromiseOrValue<string> | null,
      preCharge?: null
    ): PostOpRevertedEventFilter;
    PostOpReverted(
      user?: PromiseOrValue<string> | null,
      preCharge?: null
    ): PostOpRevertedEventFilter;
